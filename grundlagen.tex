...
Im Folgenden sollen nun die Zusammenhänge der unterschiedlichen Kompaktheitsbegriffe, gegebenenfalls unter Zusatzannahmen erörtert werden.
...
\begin{proof}
  ...
  Es bezeichne nun $f$ den Ordnungsisomorphismus $\mathcal{C} \to \mathcal{O}$ und für alle $b \in \mathcal{C}$ sei 
  \begin{displaymath}
    \mathcal{A}_b := \{ f(a) \mid a < b\}
  \end{displaymath}
  eine Teilüberdeckung von $\mathcal{O}$.
  Dann folgt für alle $b \in \mathcal{C}$, dass $A_b$ keine Überdeckung von $X$ sein kann.
  Angenommen $\bigcup A_b \supseteq X$, dann ergibt sich sofort $A_b \in \mathfrak{M}$, denn als Teilüberdeckung von $\mathcal{O}$ kann auch $A_b$ keine endliche Teilüberdeckung von $X$ besitzen.
  Dies widerspricht jedoch der Wahl von $\mathcal{C}$, da $|A_b| < \mathcal{C}$ für alle $b \in \mathcal{C}$ vorausgesetzt wurde.

  Des Weiteren gilt für alle $b \in \mathcal{C}$ und
  \begin{displaymath}
    U_b := \bigcup A_b
  \end{displaymath}
  zudem $|X \setminus U_b| \geq \mathcal{C}$.
  ...
  Dann ist jedoch
  \begin{displaymath}
    A_{b'} \cup \{O_x \mid x \in X \setminus U_{b'}\} 
  \end{displaymath}
  eine Überdeckung von $X$, die aus demselben Grund wie oben keine endliche Teilüberdeckung enthalten kann.
  Diese Überdeckung besitzt jedoch eine Kardinalität kleiner $\mathcal{C}$ was der Wahl von $\mathcal{O}$ widerspricht.

  Es ist nun möglich für alle $b \in \mathcal{C}$ ein $x_b \in X \setminus U_b$ mit $x_a \neq x_b$ für alle $a < b$ zu wählen.
  Denn für alle $b \in \mathcal{C}$ gilt $|\{x_a \mid a < b\}| < \mathcal{C}$ und, da $|X \setminus U_b| \geq \mathcal{C}$, folgt dann
  \begin{displaymath}
    S := X \setminus (U_b \cup \{x_a \mid a < b\}) \neq \emptyset.
  \end{displaymath}
  Es lässt sich also ein zu allen $x_a$ mit $a < b$ verschiedenes $x_b \in S$ auswählen.

  Man betrachte nun die Menge
  \begin{displaymath}
    M := \{ x_b \mid b \in \mathcal{C} \}.
  \end{displaymath}
  Sie besitzt keinen vollständigen Häufungspunkt, denn für alle $x \in X$ existiert ein minimales $b \in \mathcal{C}$ sodass $x \in U_b$. 
  ...
  \begin{displaymath}
    | A \cap U | < | A | \tag{$\ast$}
  \end{displaymath}
  Die Familie $\{U_x \mid x \in X\}$ ist nach Konstruktion eine Überdeckung von $X$, aufgrund der vorausgesetzten Kompaktheit existiert eine endliche Teilüberdeckung $\{U_{x_1},\dots,U_{x_n}\}$.
  Es gilt somit
  \begin{displaymath}
